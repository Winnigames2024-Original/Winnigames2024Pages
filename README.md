...
A composite Action for packaging and uploading artifact that can be deployed to [Winnigames2024 Pages][pages].
...
jobs:
  ...
  deploy:
    ...
    steps:
      ...
      - name: Upload with Winnigames2024 Pages
        uses: Winnigames2024-Original/Winnigames2024Pages@main
```
...
[release-list]: https://github.com/Winnigames2024-Original/Winnigames2024Pages/releases
